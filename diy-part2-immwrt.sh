...
# Modify default IP（FROM 192.168.1.1 CHANGE TO 192.168.1.200）
sed -i 's/192.168.1./192.168.1.200/g' package/base-files/files/bin/config_generate
sed -i 's/192.168.1./192.168.1.200/g' package/base-files/luci2/bin/config_generate
sed -i 's/192.168.1./192.168.1.200/g' package/base-files/Makefile
sed -i 's/192.168.1./192.168.1.200/g' package/base-files/image-config.in
...
git clone https://raw.githubusercontent.com/very20101/Actions_OpenWrt-Amlogic/refs/heads/main/patch/Makefile-pv feeds/packages/utils/pv/Makefile
